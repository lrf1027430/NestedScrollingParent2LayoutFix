    ...
    private void convertViewPager(BaseViewHolder baseViewHolder, ViewPagerBean viewPagerBean) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                Log.d("aabbcc", "onPageScrolled  position = " + position);
            }
            @Override
            public void onPageSelected(int position) {
//                NestedScrollTestFragment  nestedScrollTestFragment = (NestedScrollTestFragment)adapter.getItem(position);
//                mNestedScrollingParent2Layout.setLastItem(nestedScrollTestFragment.recyclerView);
